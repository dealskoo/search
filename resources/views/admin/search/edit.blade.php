...
@section('title',__('search::search.edit_search'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('search::search.edit_search') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('search::search.edit_search') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.searches.update',$search) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" required
                                       value="{{ old('name',$search->name) }}" autofocus tabindex="1"
